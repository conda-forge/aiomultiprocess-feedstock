...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aiomultiprocess-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10674&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aiomultiprocess-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aiomultiprocess` can be installed with:

```
conda install aiomultiprocess
```

It is possible to list all of the versions of `aiomultiprocess` available on your platform with:
